      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-400 text-lg max-w-xl mx-auto">
            Have an idea, opportunity, or just want to talk engineering? I'd love
            to hear from you.
          </p>
        </motion.div>
            ...
            {status === "sending" ? (
              <span className="flex items-center justify-center gap-2">
                <motion.span
                  ...
                  className="inline-block w-4 h-4 border-2 border-[#0B0F14] 
          ...
          <AnimatePresence>
            {status === "success" && (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0 }}
                className="text-teal-400 font-medium flex items-center gap-2"
              >
                <motion.span
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
        ...
        >
          <p className="text-slate-400 text-sm">Or reach me directly:</p>
